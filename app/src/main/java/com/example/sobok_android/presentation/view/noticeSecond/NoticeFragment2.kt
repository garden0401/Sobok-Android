    ...
    private fun initNoticeListAdapter() {
        ...
        noticeListAdapter2.noticeList2.addAll(
            listOf(
                ...
                NoticeData(200, true, "알림리스트 조회 성공", NoticeData.Data(
                    NoticeData.Data.Info(45, "calendar", "refuse", true, "오후 11:35", "garden", "비타민D", 453)
                )),
                NoticeData(200, true, "알림리스트 조회 성공", NoticeData.Data(
                    NoticeData.Data.Info(45, "calendar", "accept", true, "오후 11:37", "garden", "비타민D", 453)
                )),
                NoticeData(200, true, "알림리스트 조회 성공", NoticeData.Data(
                ...
                NoticeData(200, true, "알림리스트 조회 성공", NoticeData.Data(
                    NoticeData.Data.Info(48, "calendar", "waiting", true, "오후 12:37", "yayayay", "비타민C", 453)
                )),
                NoticeData(200, true, "알림리스트 조회 성공", NoticeData.Data(
